                            ...
                            <g:form method="post" action="updateAntiquity">
                                ...
                                <fieldset class="form">
                                    ...
                                    <div class="fieldcontain ${hasErrors(bean: employeeInstance, field: 'salary', 'error')} required">
                                        ...
                                        <input class="form-control" name="salary" id="cedula" value="${employeeInstance?.salary}">
                                    </div>
                                    ...
                                    <div class="fieldcontain ${hasErrors(bean: employeeInstance, field: 'admissionDate', 'error')} required">
                                    ...
                                    <div class="fieldcontain ${hasErrors(bean: employeeInstance, field: 'dischargeDate', 'error')} required">
                                        <label for="admissionDate">
                                            <g:message code="employee.cedula.label" default="Fecha de Egreso" />
                                        </label>
                                        <g:datePicker name="admissionDate" precision="day"  value="${employeeInstance?.dischargeDate}" noSelection="['':'']" />
                                    </div>
