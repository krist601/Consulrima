                                        ...
                                        <div id="edit-secAppUser" class="content scaffold-edit" role="main">
                                            ...
                                            <g:form method="post"  enctype="multipart/form-data">
                                                ...
                                                <fieldset class="form">
                                                    ...
                                                    <div class="fieldcontain ${hasErrors(bean: secAppUserInstance, field: 'password', 'error')} required">
                                                        <label for="password">
                                                            <g:message code="secAppUser.password.label" default="Repite la Contraseña" />
                                                            <span class="required-indicator">*</span>
                                                        </label>
                                                        <g:textField name="password2" class="form-control" required="" value=""/>
                                                    </div>
                                                    <br>
                                                </fieldset>
                                                <fieldset class="buttons">
                                                    <g:actionSubmit class="btn btn-info" action="updatePassword" value="${message(code: 'default.button.update.label', default: 'Update')}" />
                                                </fieldset>
                                            </g:form>
                                        </div>
                                    </div>
